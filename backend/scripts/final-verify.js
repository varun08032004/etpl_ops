...
async function main() {
  try {
    ...
    console.log('GST Collected:', gstRes.statusCode, JSON.parse(gstRes.data).totals);
    ...
    console.log('GST Liability:', liabilityRes.statusCode, JSON.parse(liabilityRes.data));
    ...
    console.log('Settlement:', settlementRes.statusCode, JSON.parse(settlementRes.data).totals);
