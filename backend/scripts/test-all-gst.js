...
async function main() {
  try {
    ...
    // Test GST Collected with detailed error
    ...
    console.log('Liability:', liabilityRes.statusCode, liabilityRes.data);
    ...
    console.log('Settlement:', settlementRes.statusCode, settlementRes.data);
